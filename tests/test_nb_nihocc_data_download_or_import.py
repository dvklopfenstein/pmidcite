...
#
# It is not advisable to add these files to a repo or revision manage
# them because the number of files will multitudinous.;W
# So ensure `./icite` is listed in the `.gitignore` file.
#
# NOTE: The Python API always downloads data from the NIH-OCC,
# even if it has been requested before. See the notebook,
# *Download or import citation data from the NIH-OCC*.
...
def test_nihocc_data_download_or_import():
    ...
    #
    # The NIH downloader will read already downloaded NIH-OCC data if it is available.
    # This makes it possible to work offline using previously downloaded citation data.
