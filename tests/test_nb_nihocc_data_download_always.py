...
#
# It is not advisable to add these files to a repo or revision manage them
# because the number of files will multitudinous.
# So ensure `./icite` is listed in the `.gitignore` file.
#
# NOTE: The Python API always downloads data from the NIH-OCC,
# even if it has been requested before.
