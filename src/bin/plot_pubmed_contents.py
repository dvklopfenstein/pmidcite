...
def _get_name2cnt():
    ...
    #  1,816,367 all_ml0_pmc0b        all [sb] NOT inprocess[sb] NOT medline[sb] NOT pubmed pmc[sb] NOT pubstatusnihms NOT pubstatuspmcsd
    ...
    #  5,250,618 pmc_all?             pubmed pmc[sb] AND (inprocess[sb] OR medline[sb] OR pubmednotmedline[sb])
    #     73,321 pmc_unknown          pubmed pmc[sb] NOT inprocess[sb] NOT medline[sb] NOT pubmednotmedline[sb]
    ...
    return {
        ...
        "pmcsd_pmc1": 59242,
        "pmcsd_pmc0": 903,
        "inprocess_A_all": 557390,
        "inprocess_A_pmc0": 422103,
        "inprocess_A_pmc1": 135287,
